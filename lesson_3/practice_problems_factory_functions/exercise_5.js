...
function createInvoice(services) {
  ...
  return {
    ...
    addPayments: function(payments) {
      payments.forEach(payment => this.payments.push(payment.total()));
    },

    amountDue: function() {
      return this.phoneBill + this.internetBill - this.payments.reduce((acc, curr) => acc + curr, 0);
    }
  }
}
...
// add payments to invoices by updating the create invoice function
